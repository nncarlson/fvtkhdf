program vtkhdf_mb_test
  ...
  call vizfile%write_cell_data(hblk_a, hcell_velocity, vector_cell_data)
  ...
  call vizfile%write_field_data(hblk_a, hfield_value, 42.0_r8)
  call vizfile%write_field_data(hblk_a, hfield_scalar, scalar_field_data, as_vector=.true.)
  call vizfile%write_field_data(hblk_a, hfield_vector, vector_field_data)
  ...
  call vizfile%write_cell_data(hblk_a, hcell_radius, scalar_cell_data+1)
  call vizfile%write_cell_data(hblk_a, hcell_velocity, vector_cell_data+1)
  call vizfile%write_point_data(hblk_b, hpoint_radius, scalar_point_data+1)
  call vizfile%write_point_data(hblk_b, hpoint_velocity, vector_point_data+1)
  call vizfile%write_field_data(hblk_a, hfield_scalar, [10.0_r8, 20.0_r8, 30.0_r8])
  call vizfile%finalize_time_step()
